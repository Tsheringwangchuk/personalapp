...
public class SpellingLevel extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_spelling_level);
...
//        Level4.setOnClickListener(this);
    ...
    public void onClick(View v) {
        if (CategoryValue.equals("Category_3")) {
            ...
            switch (v.getId()) {
                ...
                case R.id.Level1:
                    ...
                    Intent intentJavaLevel1 = new Intent(SpellingLevel.this, SpellingQuestion.class);
                    intentJavaLevel1.putExtra("Category", Question.CATEGORY_THREE);
                ...
                case R.id.Level2:
                    ...
                    Intent intentJavaLevel2 = new Intent(SpellingLevel.this, SpellingQuestion.class);
                    intentJavaLevel2.putExtra("Category", Question.CATEGORY_THREE);
                ...
                case R.id.Level3:
                    ...
                    Intent intentJavaLevel3 = new Intent(SpellingLevel.this, SpellingQuestion.class);
                    intentJavaLevel3.putExtra("Category", Question.CATEGORY_THREE);
                ...
                case R.id.Level4:
                    ...
                    Intent intentJavaLevel4 = new Intent(SpellingLevel.this, SpellingQuestion.class);
                    intentJavaLevel4.putExtra("Category", Question.CATEGORY_THREE);
    ...
    private void lockandUnlockLevels() {
        ...
        JL1 = sharedPreferences.getInt(Constants.KEY_SPELL_LEVEL_1, 0);
        JL2 = sharedPreferences.getInt(Constants.KEY_SPELL_LEVEL_2, 0);
        JL3 = sharedPreferences.getInt(Constants.KEY_SPELL_LEVEL_3, 0);
        JL4 = sharedPreferences.getInt(Constants.KEY_SPELL_LEVEL_4,0);

        // Level 1
        if (JL1 == 1) {
            Level1.setClickable(true);
            Level1.setOnClickListener(this);
            Level1.setBackgroundResource(R.drawable.level3_bg);
        ...
        if (JL2 == 1) {
            ...
            Level2.setOnClickListener(this);
            Level2.setBackgroundResource(R.drawable.level3_bg);
        ...
        if (JL4 == 1) {
            ...
            Level4.setOnClickListener(this);
            Level4.setBackgroundResource(R.drawable.level3_bg);
