...
public class divisionlevel extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_divisionlevel);
    ...
    public void onClick(View v) {
        if ((CategoryValue.equals("Category_2")) && (SubcategoryValue.equals("Subcategory_4"))) {

            switch (v.getId()) {
                case R.id.Level1:

                    Intent intentJavaLevel1 = new Intent(divisionlevel.this, division_question.class);
                    intentJavaLevel1.putExtra("Category", Question.CATEGORY_TWO);
                    intentJavaLevel1.putExtra("Subcategory", Question.SUBCATEGORY_FOUR);
                ...
                case R.id.Level2:
                    ...
                    Intent intentJavaLevel2 = new Intent(divisionlevel.this, division_question.class);
                    intentJavaLevel2.putExtra("Category", Question.CATEGORY_TWO);
                    intentJavaLevel2.putExtra("Subcategory", Question.SUBCATEGORY_FOUR);
                ...
                case R.id.Level3:
                    ...
                    Intent intentJavaLevel3 = new Intent(divisionlevel.this, division_question.class);
                    intentJavaLevel3.putExtra("Category", Question.CATEGORY_TWO);
                    intentJavaLevel3.putExtra("Subcategory", Question.SUBCATEGORY_FOUR);
                ...
                case R.id.Level4:
                    ...
                    Intent intentJavaLevel4 = new Intent(divisionlevel.this, division_question.class);
    ...
    private void lockandUnlockLevels() {
        ...
        JL1 = sharedPreferences.getInt(Constants.KEY_MATHDIV_LEVEL_1, 0);
        JL2 = sharedPreferences.getInt(Constants.KEY_MATHDIV_LEVEL_2, 0);
        JL3 = sharedPreferences.getInt(Constants.KEY_MATHDIV_LEVEL_3, 0);
        JL4 = sharedPreferences.getInt(Constants.KEY_MATHDIV_LEVEL_4,0);
