...
public class additionlevel extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_additionlevel);
    ...
    public void onClick(View v) {
        if ((CategoryValue.equals("Category_2")) && (SubcategoryValue.equals("Subcategory_1"))) {

            switch (v.getId()) {
                case R.id.Level1:

                    Intent intentJavaLevel1 = new Intent(additionlevel.this, addition_question.class);
                ...
                case R.id.Level2:
                    ...
                    Intent intentJavaLevel2 = new Intent(additionlevel.this, addition_question.class);
                ...
                case R.id.Level3:
                    ...
                    Intent intentJavaLevel3 = new Intent(additionlevel.this, addition_question.class);
                    intentJavaLevel3.putExtra("Category", Question.CATEGORY_TWO);
                    intentJavaLevel3.putExtra("Subcategory", Question.SUBCATEGORY_ONE);
                ...
                case R.id.Level4:
                    ...
                    Intent intentJavaLevel4 = new Intent(additionlevel.this, addition_question.class);
                    intentJavaLevel4.putExtra("Category", Question.CATEGORY_TWO);
                    intentJavaLevel4.putExtra("Subcategory", Question.SUBCATEGORY_ONE);
    ...
    private void lockandUnlockLevels() {
        ...
        JL1 = sharedPreferences.getInt(Constants.KEY_MATHADD_LEVEL_1, 0);
        JL2 = sharedPreferences.getInt(Constants.KEY_MATHADD_LEVEL_2, 0);
        JL3 = sharedPreferences.getInt(Constants.KEY_MATHADD_LEVEL_3, 0);
        JL4 = sharedPreferences.getInt(Constants.KEY_MATHADD_LEVEL_4,0);
